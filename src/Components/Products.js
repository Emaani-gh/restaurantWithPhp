        ...
        <div className="featured-section my-3 py-sm-4 my-sm-5">
          {context.state.products.find((ele) => ele.checked == true) ? (
            <div
              ...
              onClick={context.actions.handleAddSelectedToCart}
            >
              Add All to Cart
            </div>
          ) : (
          ...
          <div className="featured  d-sm-grid">
            {featuredProducts.map((product) => {
              ...
              return (
                <div
                  key={id}
                  className=" product p-sm-0 mb-sm-0 shadow  mb-5 bg-body rounded"
                >
                  <input
                    type={"checkbox"}
                    value={id}
                    className="mx-2 my-2 align-self-end"
                    checked={product.checked || false}
                    onChange={(e) => context.actions.handleCheck(e)}
                  />
                  <div
                    className="d-flex flex-column px-2"
                    data-bs-toggle="modal"
                    data-bs-target="#exampleModal"
                    onClick={() => context.actions.showProduct(product)}
                  >
                    <div className="">
                  ...
                  <div className="w-100 px-2">
                    <button
                      ...
                      onClick={() => context.actions.addToCart(product)}
                      role="button"
                    >
                      {" "}
                      Add To Cart
        ...
        <div className="container">
          ...
          <div className="row">
            {context.state.products.map((product, index) => (
              <div
                key={product.id}
                className="col-sm-4 col-lg-3 col-xxl-2 mb-5 btn p-2"
              >
                <div
                  type="button"
                  className=" cardd h-100 border p-3 shadow d-flex flex-column"
                >
                  <input
                    type={"checkbox"}
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabel">
                {context.state.currproduct.title}
              </h1>
              <button
                type="button"
                className="btn-close"
              ...
              <div className="container d-sm-flex  product-detail py-4">
                ...
                <div className="right pt-4 px-4">
                  ...
                  <div className="mt-4 p-detail ">
                    ...
                    <p className="">{context.state.currproduct.description}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() =>
                  context.actions.addToCart(context.state.currproduct)
                }
              >
                Add To Cart
              </button>
